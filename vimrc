...
" Plugin 'git@bitbucket.org:esatbitbucket/vimfiles.git'
...
let g:C_Styles = { '.c,.h' : 'C', '.cc,.cpp,.c++,.C,.hh,.h++,*.H,*.hpp' : 'CPP' }
...
" Avoid conflict with UltiSnips (http://www.alexeyshmalko.com/2014/youcompleteme-ultimate-autocomplete-plugin-for-vim/)
